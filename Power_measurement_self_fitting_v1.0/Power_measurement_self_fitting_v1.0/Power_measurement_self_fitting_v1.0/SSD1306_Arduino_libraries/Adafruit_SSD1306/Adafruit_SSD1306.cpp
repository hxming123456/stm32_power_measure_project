...
void SSD1306::drawPixel(int16_t x, int16_t y, uint16_t color) {
  ...
  SSD1306::SSD1306(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS) {
  cs = CS;
  rst = RST;
  dc = DC;
  sclk = SCLK;
...
void SSD1306::clearBuffer(){
    ...
    for (uint16_t i=0; i<(SSD1306_LCDHEIGHT/8); i++) {
      for (uint8_t x=0; x < SSD1306_LCDWIDTH; x++) buffer[x+i*SSD1306_LCDWIDTH] = 0;
	}
}
...
inline void SSD1306::slowSPIwrite(uint8_t d) {
